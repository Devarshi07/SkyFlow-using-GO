...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	airports := h.svc.List(r.Context())
	response.WriteOK(w, r, map[string]any{"airports": airports})
}

func (h *Handler) GetByID(w http.ResponseWriter, r *http.Request) {
	id := chi.URLParam(r, "id")
	a, appErr := h.svc.GetByID(r.Context(), id)
	if appErr != nil {
		response.WriteError(w, r, appErr.WithRequestID(middleware.GetRequestID(r.Context())), h.log)
		return
	}
	response.WriteOK(w, r, a)
}
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	a, appErr := h.svc.Create(r.Context(), req)
	if appErr != nil {
		response.WriteError(w, r, appErr.WithRequestID(middleware.GetRequestID(r.Context())), h.log)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	a, appErr := h.svc.Update(r.Context(), id, req)
	if appErr != nil {
		response.WriteError(w, r, appErr.WithRequestID(middleware.GetRequestID(r.Context())), h.log)
		return
	}
